package com.ahrokholska.create_note.presentation.type
...
import com.ahrokholska.create_note.presentation.BlackAlpha40
...
@Composable
internal fun SelectNoteTypeScreen(
    onBackClick: () -> Unit,
...
@Composable
internal fun SelectNoteTypeScreenContent(
    onBackClick: () -> Unit = {},
    onTypeClick: (NoteType) -> Unit = {}
) {
    Scaffold(
